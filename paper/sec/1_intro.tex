...
We introduce \emph{LiveQA-Bench}, 500 temporally-diverse questions spread across 50 simulated live streams of 5 to 30 minutes, with explicit scope labels inspired by the per-type evaluation in NExT-QA~\cite{xiao2021nextqa}.
