...
3. Edit the `REPO_URL` in the first cell (or upload a zip of the `VAR/` folder)
...
!pip install -r /content/VAR/demo/backend/requirements.txt

!python /content/VAR/eval/run_docker_eval.py --project-root /content/VAR
```
