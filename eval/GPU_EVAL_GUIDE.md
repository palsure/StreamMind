...
export PYTHONPATH=/path/to/StreamMind-LiveQA/demo/backend:$PYTHONPATH
...
import os
os.environ["PYTHONPATH"] = "/content/StreamMind-LiveQA/demo/backend"
!python /content/StreamMind-LiveQA/eval/run_docker_eval.py
```
...
git clone https://github.com/palsure/StreamMind-LiveQA.git ~/StreamMind-LiveQA
cd ~/StreamMind-LiveQA
pip install -r eval/requirements.txt rouge-score
pip install -r demo/backend/requirements.txt
export PYTHONPATH=$PWD/demo/backend
python eval/run_docker_eval.py
```
